  ...
  return (
    <Ctx.Provider value={value}>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-md w-[calc(100%-1.5rem)] p-0 border-0 bg-background shadow-2xl max-h-[90dvh] overflow-y-auto overscroll-contain [&>button]:z-50 [&>button]:bg-background/80 [&>button]:backdrop-blur-sm [&>button]:rounded-full [&>button]:p-1.5">
          <Paywall asModal />
        </DialogContent>
      </Dialog>
    </Ctx.Provider>
