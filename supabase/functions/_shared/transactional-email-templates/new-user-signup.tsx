...
const NewUserSignupEmail = ({
  ...
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Novo cadastro no Volant: {email}</Preview>
    <Body style={main}>
      <Container style={container}>
        <Heading style={h1}>Novo cadastro no Volant</Heading>
        <Text style={text}>Um novo usuário acabou de criar uma conta.</Text>
        <Section style={card}>
          <Row label="Nome" value={name} />
          <Row label="E-mail" value={email} />
          <Row label="Método" value={method} />
          <Row label="Data/hora" value={createdAt} />
